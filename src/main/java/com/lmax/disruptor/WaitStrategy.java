...
/**
 * 当没有可消费的事件时，根据特定的实现进行等待。
 *
 * 实现类=》final：BlockingWaitStrategy、BusySpinWaitStrategy、LiteBlockingWaitStrategy、PhasedBackoffWaitStrategy、SleepingWaitStrategy、YieldingWaitStrategy
 *
 * =》非final：LiteTimeoutBlockingWaitStrategy、TimeoutBlockingWaitStrategy
 */
